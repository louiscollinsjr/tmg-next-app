    ...
    <main className="max-w-5xl mx-auto p-8 sm:px-6 lg:px-8 min-h-[calc(80vh-64px)] text-left sm:text-center flex flex-col justify-center font-roboto">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="text-3xl sm:text-5xl tracking-tight font-bold text-black mb-2 w-[80%] sm:w-full">
          Find <span className="text-burnt-orange">trusted pros</span>,
          recommended by{" "}
          <span className="text-burnt-orange">our community</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
          <button
            ...
            className="inline-flex items-center justify-center px-6 py-3 text-base font-medium text-white bg-black rounded-full hover:bg-gray-700 transition-colors w-fit tracking-wider"
          >
            Join waitlist{" "}
            <svg
              xmlns="http://www.w3.org/2000/svg"
