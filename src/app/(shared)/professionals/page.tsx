...
export default function ProfessionalsPage() {
  ...
  return (
    <main className="flex min-h-screen flex-col bg-zinc-100">
      ...
      <div className="px-[22px] ~mt-24/40">
        <div className="max-w-7xl mx-auto md:px-[22px]">
          <div className="bg-gradient-to-br from-burnt-orange to-[rgb(255,88,22)] text-white py-20 rounded-3xl">
            <div className="px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                <h2 className="~text-5xl/7xl  md:~text-6xl/9xl font-bold ~px-8/20 mb-6 font-tiro-bangla tracking-wide">
                  Free to join. Easy to use.
                </h2>
                <p className="~text-base/3xl max-w-xl mx-auto">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-2 items-center justify-center mx-auto">
                ...
                <div className="text-center">
                  ...
                  <div className="font-bold ~text-base/2xl mb-2">Find jobs</div>
                </div>
                ...
                <div className="text-center flex flex-col items-center">
                  ...
                  <div className="font-bold ~text-base/2xl mb-2">Get paid</div>
                </div>
                ...
                <div className="text-center flex flex-col items-center">
                  ...
                  <div className="font-bold ~text-base/2xl mb-2">Easy!</div>
                </div>
              </div>
            </div>
          </div>
